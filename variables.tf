...
variable "name" {
  type        = string
  description = "Name of key resources of the cluster of DocumentDB"
  default     = "docdb"
}

variable "cluster_name" {
  type        = string
  description = "Name of the cluster of DocumentDB"
  default     = "documentDb"
}

variable "environement" {
  type        = string
  description = "Name of environement of the cluster of DocumentDB"
  default     = "test"
}
...
variable "instance_class" {
  type        = string
  default     = "db.t3.medium" #"db.r4.large"
